...
Route::get('Project/close/{id}', 'ProjectController@close');
Route::get('Project/open/{id}', 'ProjectController@open');
...
Route::get('activity', 'CustomerController@activities');
Route::get('activity/All', 'CustomerController@getactivity');
Route::get('calc/{id}', 'CustomerController@calc');
...
Route::get('Customer/v2/{id}/show', 'CustomerController@show_2');
...
Route::post('Customer/delete_customers_from_project', 'CustomerController@delete_customers_from_project');
...
Route::get('Report/EditNeedCustomer', 'CustomerController@editNeedCustomer');
Route::get('Report/EditNeedCustomerData', 'CustomerController@editNeedCustomerData');
