...
//    use SoftDeletes;
    ...
    function furnitures()
    {
        return $this->belongsToMany(Furniture::class, 'customer_furnitures_copy', 'customer_id', 'furniture_id')->withPivot('count', 'rate');
    }
...
// additional helper relation for the count
    ...
    {
        return $this->belongsToMany(Furniture::class,'customer_furnitures_copy','customer_id')
