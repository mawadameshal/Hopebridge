...
//        parent::$data['customer']->calculatePoint();
    ...
    function personal($id = 0, Request $request)
    {
        ...
        $data = $request->only('name', 'state_id', 'researcher_name', 'region_id', 'neighborhood', 'address', 'street', 'mobile', 'mobile2');
        ...
        if ($id) {
            ...
            $customer->file_no = parent::$data["state_char"][$request->state_id] . '-' . $customer->id;
            $customer->save();
