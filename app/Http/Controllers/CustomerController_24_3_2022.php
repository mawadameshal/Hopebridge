...
//            $customer = Customer::create($data);
            ...
            if ($customer->type == 3) {
                $data['file_no'] = $customer->file_no = 'W-' . $this->state_char($request->state_id) . '-' . $customer->main_id;
            } else {
                $data['file_no'] =  $customer->file_no = $this->state_char($request->state_id) . '-' . $customer->main_id;
            }
            $customer->save();
