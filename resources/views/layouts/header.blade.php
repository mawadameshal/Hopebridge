<nav class="navbar">
    ...
    <form class="navbar-search d-none d-sm-block" role="search"><i class="feather feather-search list-icon"></i>
        <input type="search" class="search-query" placeholder="ابحث"> <a href="javascript:void(0);"
            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                ...
                <div class="dropdown-menu dropdown-right dropdown-card animated flipInY">
                    <div class="card">
                        ...
                        <!-- /.dropdown-list-group -->
                        <footer class="card-footer text-center"><a href="/activity"
                                                                   class="headings-font-family text-uppercase fs-13">عرض جميع الاشعارات</a>
                        </footer>
                    </div>
                    <!-- /.card -->
                </div>
    ...
    <ul class="nav navbar-nav">
        <li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle dropdown-toggle-user ripple"
                            ...
                            style="padding-right: 20px;"> {{auth()->user()->name}}</span>
{{--                    <img src="uploads/avatars/{{ auth()->user()->avator}}" class="rounded-circle" alt="">--}}
