                ...
                <div id="rootwizard">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab7">
                            @include('customers.tabs.family_composition_details')
...
//                    "scrollCollapse": true
        ...
        $('.add-new-child').click(function () {
            ...
            var keyx = parseInt($('#children td:nth-child(1):last').text()) + 1;
        ...
        function total_income() {
            ...
            $('#total_income_2').text(total + ' شيكل');
            $('#total_income_2').data('income' ,total);
            total_outcome();
        }
        ...
        function total_outcome() {
            ...
            var total_income = $('#total_income_2').data('income');
            $('.income_amount').each(function () {
