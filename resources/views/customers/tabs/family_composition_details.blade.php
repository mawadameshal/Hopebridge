<form action="{{route('customers.familyCompositionDetails',$customer->id)}}" method="post" id="familyCompositionDetails">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    ...
                    <input id="child_dob" type="text"
                           class="form-control child_dob" data-date-format="yyyy"
