            ...
            <div class="portlet-body form">
                <table id="data_tb" dir="rtl" class="table  table-bordered table-hover table-responsive"
                    ...
                    <tr>
                        ...
                        <th> المحافظة</th>
                        <th>المنطقة</th>
                        <th> المستخدم الذي قام بالاضافة</th>
                        <th> المستخدم الذي قام بالتعديل</th>
                        <th> المستخدم الذي قام بالموافقة</th>
            ...
            <form id="approveForm" action="" method="post">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">هل انت متاكد من قبول المستفيد</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="submit" value="accept" class="btn btn-primary">قبول</button>
                        <button type="submit" name="submit" value="reject" class="btn btn-primary">رفض</button>
                    </div>
    ...
    @push('js')
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('body').on('click', '.approve_btn', function (e) {
                    e.preventDefault();
                    $('#approveForm').attr('action', $(this).attr('href'));
                ...
                $(function () {
                    ...
                    oTable = $("#data_tb").DataTable({
                        ...
                        "columns": [
                            ...
                            {'data': 'researcher_name', 'name': 'researcher_name'},
                            // {'data': 'user.name', 'name': 'user_id'},
                            {'data': 'updated_id', 'name': 'updated_id'},
                            {'data': 'approved.name', 'name': 'approved_id'},
