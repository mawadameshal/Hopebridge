    ...
    <div class="col-md-3">
        <div class="form-group selectbs-wlbl">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <input type="text" id="beneficiary_count" name="beneficiary_count" class="form-control searchable"
                           placeholder="من">
                </div>
                <div class="col-md-6">
    ...
    <div class="row" style="position: relative">
        ...
        <div class="col-md-3">
            <div class="form-group selectbs-wlbl">
                ...
                <select data-column="1" name="state" id="state" class="bs-select form-control searchableList" onChange="getState();">
