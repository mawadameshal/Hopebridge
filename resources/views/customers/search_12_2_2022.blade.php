    ...
    <section class="content">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <table id="data_tb" dir="rtl" class="table  table-bordered table-hover table-responsive" style="display: block">
                        <thead>
                        <tr>
                ...
                $(function () {
                    ...
                    oTable = $("#data_tb").DataTable({
                        ...
                        'columnDefs': [{
                            ...
                            //     return '<input type="checkbox" class="call-checkbox" name="id[]" value="'+data.name+'">';
                            // }
                        }],
                        'order': [[1, 'asc']],
                        "ajax": {
