                            ...
                            <div style="font-size: 18px;">
                                <div style="position: absolute;right: 30px;bottom: 15px;">
                                    <strong>المحافظة</strong>: <span
                                            style="background: #eee;padding: 5px 10px">{{$coupon->orphan->getState->name??''}}</span>
                            ...
                            <table border="1" style="height: 120px;width: 100%;text-align: center">
                                <tr align="center">
                                    ...
                                    <td align="center" style="background: #eee">
                                        <div class="couponh">{{ $coupon->orphan->name  }}</div>
                                    </td>
                                    <td align="center">
                                        الهوية
                                    </td>
                                    <td align="center" style="background: #eee">
                                        <div class="couponh">{{ $coupon->orphan->card_no }}</div>
                                    </td>
                                </tr>
                                <tr align="center">
                                    <td>نقطة التسليم</td>
