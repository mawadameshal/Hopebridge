            ...
            <div class="portlet-body collapse-body form">
                <form action="#" class="horizontal-form">
                    ...
                    <div class="form-body" style="padding: 10px;">
                        ...
                        @include('orphans_report.filter_report',['type'=>1])
                        ...
                        <div class="col-md-3 clearfix ">
                            <div class="btn-search-reset pull-right">
                                ...
                                <button type="button" style="background-color: red"
                                        class="btn info btn-count">تم اختيار
                                    <label id="orphans_count" style="color: #FFFFFF !important;margin:2px 5px 2px 5px;font-size: 14px !important;"></label>
                                    مستفيد
                                </button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label col-md-3">رقم الكشف </label>
                                <div class="col-md-9">
                                    <input type="text" name="tag" class="form-control" placeholder="رقم الكشف" >
                                    <span class="tag" style="color: darkred"></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('js')
    ...
    <script>
        function selectAll(source) {
            ...
            let checkboxes = document.getElementsByName('selOrphan[]');
            for (let i = 0; i < checkboxes.length; i++) { // Use a standard for loop
                checkboxes[i].checked = source.checked;
            }
        }

        $(document).on('change', '.mycheckbox', function (e) {
            var selectedCount = $('.mycheckbox:checked').length;
            // Perform your actions with the count of selected checkboxes here
            console.log('Selected count: ' + selectedCount);
            $('#orphans_count').text(selectedCount);
        });
        ...
        $(document).ready(function () {
            $('#project_id').multiselect({placeholder: 'اختر المشروع'});
            // $('#region').multiselect({placeholder:'اختر المنطقة'});
            $('#orphans_count').text('0');
            ...
            $(function () {
                var url = '{{url("OrphanReport/NeedOrphanData")}}';
                ...
                oTable = $("#data_tb").DataTable({
                    ...
                    "ajax": {
                        ...
                        data: function (d) {
                            ...
                            d.orphan_id = document.getElementById('orphan_id').value;
                            d.orphan_id_to = document.getElementById('orphan_id_to').value;
