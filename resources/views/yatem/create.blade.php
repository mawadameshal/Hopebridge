    ...
    <section class="content" style="float: right;">
                                    ...
                                    <div class="media-body">
                                        <p class="text-muted mr-b-5">رقم الملف</p><span
                                                class="counter-title color-primary"><span
                                                    class="counter">{{$orphan->file_no}}</span> </span>
                                    ...
                                    <div class="media-body">
                                        <p class="text-muted mr-b-5">التقييم</p><span
                                                class="counter-title color-info"><span
                                                    class="counter points">{{$orphan->total}}</span></span>
                            ...
                            <div class="counter-w-warning media">
                                <div class="media-body">
                                    <p class="text-muted mr-b-5">أخر تحديث</p><span
                                            class="counter-title color-info"><span
                                                style="direction: ltr">{{$orphan->updated_at}}</span></span>
                                    <!-- /.counter-title --> <span class="counter-difference text-danger"></span>
                                    <div class="progress" style="width: 70%; position: relative; top: 25px">
        ...
        <div class="card">
            <div class="card-header">
                {{!isset($stage)?"تعديل بيانات ".$orphan->name:'يتيم جديد'}}
            </div>
                ...
                <div id="rootwizard">
                    ...
                    <div class="navbar ">
                        <div class="navbar-inner">
                            <div class="container">
                                <ul style="padding-right: 0;display: inline-table;">
                                    <li class="col"><a href="#tab1" data-toggle="tab">بيانات عامة</a></li>
                                    <li class="col"><a href="#tab2" data-toggle="tab"> معلومات عن اليتيم</a></li>
                                    <li class="col"><a href="#tab3" data-toggle="tab">معلومات عن الاب</a></li>
                                    ...
                                    <li class="col"><a href="#tab11" data-toggle="tab">تفاصيل الاسرة</a></li>
                                    <li class="col"><a href="#tab12" data-toggle="tab">الكفالات</a></li>
                                    <li class="col"><a href="#tab13" data-toggle="tab">المرفقات</a></li>
                                    <li class="col"><a href="#tab14" data-toggle="tab">تم</a></li>
                                </ul>
                    ...
                    <div class="tab-content" style="margin-top: 130px;">
                        <hr style="border: solid 1px #1976d2;margin-bottom: 30px;">
                        <div class="tab-pane" id="tab1">
                            @include('yatem.tabs.personal')
                        </div>
                        <div class="tab-pane" id="tab2">
                            @include('yatem.tabs.information_of_orphan')
                        </div>
                        <div class="tab-pane" id="tab3">
                            @include('yatem.tabs.father_info')
                        </div>
                        <div class="tab-pane" id="tab4">
                            @include('yatem.tabs.information_guardian')
                        </div>
                        <div class="tab-pane" id="tab5">
                            @include('yatem.tabs.family_composition')
                        </div>
                        <div class="tab-pane" id="tab6">
                            @include('yatem.tabs.family_educational_status')
                        </div>
                        <div class="tab-pane" id="tab7">
                            @include('yatem.tabs.child_psychological_health_condition')
                        </div>
                        <div class="tab-pane" id="tab8">
                            @include('yatem.tabs.work_info')
                        </div>
                        <div class="tab-pane" id="tab9">
                            @include('yatem.tabs.housing_data')
                        </div>

                        <div class="tab-pane" id="tab10">
                            @include('yatem.tabs.social_researcher')
                        </div>

                        <div class="tab-pane" id="tab11">
                            @include('yatem.tabs.family_composition_details')
                        </div>

                        <div class="tab-pane" id="tab12">
                            @include('yatem.tabs.guarantees')
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <table class="table table-striped text-center">
                                        <tr>
                                            <td>رقم الملف</td>
                                            <td><p id="file_no">{{$orphan->file_no}}</p></td>
                                        </tr>
                                        <tr>
                                            <td>التقيم</td>
                                            <td><p class="points">{{$orphan->total}}</p></td>
                                        </tr>
                                        <tr>
                                            <td>اسم مدخل الطلب</td>
                                            <td><p id="file_no">{{$orphan->user->name}}</p></td>
                                        </tr>
                                        <tr>
                                            <td>اسم الباحث</td>
                                            <td><p id="file_no">{{$orphan->researcher_name}}</p></td>
                                        </tr>
                                        <tr>
                                            <td>تاريخ الاضافة</td>
                                            <td><p id="file_no">{{$orphan->created_at->format('Y-m-d')??''}}</p></td>
                                        </tr>
                                        @if($orphan->userUpdated)
                                            <tr>
                                                <td>عدل بواسطة</td>
                                                <td><p id="file_no">{{$orphan->userUpdated->name}}</p></td>
                                            </tr>

                                        @endif
                                        <tr>
                                            <td>تاريخ التعديل</td>
                                            <td><p id="file_no">{{$orphan->updated_at->format('Y-m-d')}}</p></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <ul class="pager wizard" style="float: left;">
                            ...
                            <li class="finish"><a href="{{url('Orphan')}}">خروج
...
@push('js')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var informationoforphan = $("#information_of_orphan").validate();
            var fatherInfo = $("#father-info").validate();
            var informationGuardian = $("#information_guardian").validate();
            var familyComposition = $("#family-composition").validate();
            var familyEducationalStatus = $("#family-educational-status").validate();
            var childPsychologicalHealthCondition = $("#child-psychological-health-condition").validate();
            var workInfo = $("#work-info").validate();
            var housingData = $("#housing-data").validate();
            var familyCompositionDetails = $("#familyCompositionDetails").validate();
            var researcher = $("#researcher").validate();
            var guarantees = $("#guaranteesForm").validate();
            ...
            wizard = $('#rootwizard').bootstrapWizard({
                onNext: function (tab, navigation, index) {
                    ...
                    if (index == 1) {
                        ...
                        informationoforphan.form();
                        if (informationoforphan.valid()) {
                        ...
                        informationGuardian.form();
                        if (informationGuardian.valid()) {
                            ajax($('#information_guardian'))
                        }
                        return false;
                    } else if (index == 5) {
                        ...
                        familyEducationalStatus.form();
                        if (familyEducationalStatus.valid()) {
                            ajax($('#family-educational-status'))
                        }
                        return false;
                    } else if (index == 7) {
                        childPsychologicalHealthCondition.form();
                        if (childPsychologicalHealthCondition.valid()) {
            ...
            //     ajax($('#familyCompositionDetails'), 'finish-loader')
            // });
        ...
        $('#information_of_orphan [name=child_guaranteed]').change(function () {
            $('#child_guaranteed_list.default-hide').hide();
            $('#child_guaranteed_list.default-hide input').attr('required', false);

            if ($(this).val() == '1') {
                $('#child_guaranteed_list').show();
                // $('#child_guaranteed_list input').attr('required', true);
            }
        });
        ...
        $('.add-new-work').click(function () {
            ...
            let html = `<tr>
                                            <td><input type="text" name="income_source[]" readonly value="` + income_source + `"  class="form-control" ></td>
                                            <td><input type="text" name="income_side[]" readonly value="` + income_side + `"  class="form-control" ></td>
                                            <td><input type="number" name="income_amount[]" readonly value="` + income_amount + `"   class="form-control income_amount" ></td>
                                            <td>
                                                <a href="javascript:;" class="delete-income btn btn-danger btn-sm" ><i class="fa fa-times"></i></a>
            </td>
        </tr>`;
            $('.form-add-work').before(html);
            total_income();
            $('.form-add-work input').val('');
        });


        $('.add-new').click(function () {
            //form-add
            let guaranteed_source = $('#guaranteed_source').val();
            let guaranteed_amount = $('#guaranteed_amount').val();
            let guaranteed_period = $('#guaranteed_period').val();
            if (!(guaranteed_source && guaranteed_amount && guaranteed_period)) {
                toastr.error('تأكد من ادخال الحقول');
            ...
            let html = `<tr>
                                            <td>` + m + `</td>
                                            <td><input type="text" name="guaranteed_source[]" readonly value="` + guaranteed_source + `"  class="form-control" ></td>
                                            <td><input type="number" name="guaranteed_amount[]" readonly value="` + guaranteed_amount + `"   class="form-control" ></td>
                                            <td><input type="text" name="guaranteed_period[]" readonly value="` + guaranteed_period + `"  class="form-control" ></td>
                                            <td>
        ...
        $('.add-new-need').click(function () {
            ...
            let html = `<tr>
                                            ...
                                            <td><input type="text" name="description[]" readonly value="` + description + `"  class="form-control" ></td>
        ...
        $(document).on('click', '#project_count', function (e) {
            ...
            var url = '{{url('customerProject')}}/' + '{{$orphan->id}}';
...
//                    "scrollCollapse": true
    ...
    <td><a href="javascript:;" class="delete-child btn btn-danger btn-sm"><i class="fa fa-times"></i></a></td>
        ...
        function total_outcome() {
            var total_income = {{$orphan->income_sum??0}};
            $('.income_amount').each(function () {
        ...
        $(document).on('click', '.delete-guaranteed', function () {
