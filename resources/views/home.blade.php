                    ...
                    <a href="#">
                        <div class="counter-w-info media">
                            <div class="media-body">
                                <p class="text-muted mr-b-5">عدد الطلبات</p><span
            ...
            <div class="widget-bg">
                <div class="widget-body">
                    <a href="#">
                        <div class="counter-w-info media">
                            <div class="media-body">
                                <p class="text-muted mr-b-5">عدد المشاريع</p><span
            ...
            <div class="widget-bg">
                <div class="widget-body">
                    <a href="#">
                        <div class="counter-w-info media">
                            <div class="media-body">
                                <p class="text-muted mr-b-5">عدد المستفيدين</p><span
                                        class="counter-title color-pink"><span class="counter">{{$reciever_cnt}}</span> </span>
                                <!-- /.counter-title -->
                                <div style="margin-top: 15px"><span data-toggle="sparklines" data-height="15"
                                                                    ...
                                                                    data-bar-color="#ff6b88"><!-- 2,4,5,3,2,3,5,3,2,3,5,4,2 --></span>
                                </div>
                            </div>
                            <!-- /.media-body -->
                            <div class="pull-right align-self-center"><i
                                        class="list-icon feather feather-briefcase bg-pink"></i>
                            </div>
                        </div>
                    </a>
                    <!-- /.counter-w-info -->
            ...
            <div class="widget-bg">
                <div class="widget-body">
                    <a href="#">
                        <div class="counter-w-info media">
                            <div class="media-body">
                                <p class="text-muted mr-b-5">عدد المستخدمين</p><span class="counter-title"><span
                                            class="counter">{{$user_cnt}}</span> </span>
                                <!-- /.counter-title -->
                                <div class="progress" style="width: 70%; position: relative; top: 25px">
                                    <div class="progress-bar bg-warning" style="width: 66%" role="progressbar"><span
                                                class="sr-only">20% Complete</span>
                                    </div>
                                </div>
                            </div>
                            <!-- /.media-body -->
                            <div class="pull-right align-self-center"><i
                                        class="list-icon feather feather-clock bg-warning"></i>
                            </div>
                        </div>
                    </a>
                    <!-- /.counter-w-info -->
            ...
            <div class="widget-bg">
                <div class="widget-body">
                    <a href="#">
                        <div class="counter-w-info media">
                            <div class="media-body">
                                <p class="text-muted mr-b-5">عدد الأيتام المكفولين</p><span class="counter-title"><span
                            ...
                            <!-- /.media-body -->
                            <div class="pull-right align-self-center"><i
                                        class="list-icon feather feather-user-check bg-primary"></i>
                            </div>
                        </div>
                    </a>
                    <!-- /.counter-w-info -->
            ...
            <div class="widget-bg">
                <div class="widget-body">
                    <a href="#">
                        <div class="counter-w-info media">
                            <div class="media-body">
                                <p class="text-muted mr-b-5">عدد الممولين</p><span class="counter-title"><span
                            ...
                            <!-- /.media-body -->
                            <div class="pull-right align-self-center"><i
                                        class="list-icon feather feather-briefcase bg-info"></i>
                            </div>
                        </div>
                    </a>
                    <!-- /.counter-w-info -->
