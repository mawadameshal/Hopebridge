                ...
                <div id="rootwizard">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="tab1">
                            @include('widoweds.tabs.personal')
                        </div>
                        <div class="tab-pane" id="tab2">
                            @include('widoweds.tabs.father_info')
                        </div>
                        <div class="tab-pane" id="tab3">
                            @include('widoweds.tabs.family_composition')

                        </div>
                        <div class="tab-pane" id="tab4">
                            @include('widoweds.tabs.work_info')


                        </div>
                        <div class="tab-pane" id="tab5">
                            @include('widoweds.tabs.housing_data')

                        </div>
                        <div class="tab-pane" id="tab6">
                            @include('widoweds.tabs.social_researcher')

                        </div>
                        <div class="tab-pane" id="tab7">
                            @include('widoweds.tabs.family_composition_details')

                        </div>
                        <div class="tab-pane" id="tab8">
                            @include('widoweds.tabs.attachments')
                        ...
                        <ul class="pager wizard">
                            ...
                            <li class="finish"><a href="{{url('Customer')}}">خروج
    ...
    <script>
        ...
        $('.add-new').click(function () {
            ...
            let html = `<tr>
                                            ...
                                            <td><input type="text" name="income_type[]" readonly value="` + income_type + `"  class="form-control" ></td>
