...
{{--                                    <div class="col-md-12">--}}
{{--                                        <input type="text" id="file_no" name="file_no" class="form-control searchable" placeholder="رقم الملف">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="col-md-2">--}}
...
{{--                                    <div class="row">--}}
{{--                                        <div class="col-md-6">--}}
{{--                                            <input type="text" id="child_no" name="child_no" class="form-control searchable" placeholder="من">--}}
{{--                                        </div>--}}
{{--                                        <div class="col-md-6">--}}
{{--                                            <input type="text" id="child_no_to" name="child_no" class="form-control searchable" placeholder="الى">--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                            --}}{{--<div class="col-md-3">--}}
{{--                            --}}{{--<div class="form-group selectbs-wlbl">--}}
{{--                            --}}{{--<span class="lblselect"> الحالة الصحية </span>--}}
{{--                            --}}{{--<select data-column="1" name="health" id="health" class="bs-select form-control searchableList">--}}
...
{{--                                    <select data-column="1" name="housetype" id="housetype" class="bs-select form-control searchableList">--}}
