            ...
            <div class="portlet-body collapse-body form">
                <form action="#" class="horizontal-form">
                    ...
                    <div class="form-body" style="padding: 10px;">
                        ...
                        @include('customers.filter_report',['type'=>1])
                        ...
                        <div class="col-md-3 clearfix ">
                            <div class="btn-search-reset pull-right">
                                ...
                                <button type="button" style="background-color: red"
                                    ...
                                    <label id="customers_count" style="color: #FFFFFF !important;margin:2px 5px 2px 5px;font-size: 14px !important;"></label>
                                    مستفيد
                                </button>
...
@push('js')
    ...
    <script>
        ...
        $(document).on('change', '.mycheckbox', function (e){
            ...
            $('#customers_count').text(selectedCount);
        });
        ...
        $(document).ready(function () {
            ...
            $(function () {
                var url =  '{{url("Report/NeedCustomerData")}}';
